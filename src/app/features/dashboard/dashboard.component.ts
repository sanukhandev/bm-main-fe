  ...
  template: `
    ...
    <div class="max-w-[1740px] mx-auto space-y-5 font-sans text-[#0F172A]">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-1">
        <div>
          ...
          <p class="text-xs text-[#64748B] mt-0.5">
            Real-time operational & financial snapshot for Baithul Madeena Real Estate ERP.
          </p>
        </div>
      ...
      @if (metrics()?.expiring_soon_agreements && metrics()!.expiring_soon_agreements! > 0) {
        <div
          class="p-3.5 rounded-2xl bg-[#FFFBEB] border border-[#FDE68A] text-[#0F172A] flex items-center justify-between text-xs font-medium shadow-[0_4px_16px_rgba(245,158,11,0.08)]"
        >
          <div class="flex items-center gap-3">
            <div
              class="w-8 h-8 rounded-xl bg-[#F59E0B]/20 text-[#D97706] flex items-center justify-center shrink-0"
            >
              <svg
            ...
            <div>
              <span class="font-bold text-[#0F172A]">Contract Renewal Notice:</span>
              {{ metrics()?.expiring_soon_agreements }} tenant lease agreement(s) are expiring
              within the next 30 days.
            </div>
          </div>
          <a
            routerLink="/app/tenant-agreements"
            class="font-semibold text-[#047857] hover:underline flex items-center gap-1"
          >
            Review Contracts →
          </a>
        </div>
      ...
      @if (isLoading()) {
        ...
        >
          ...
          >
            ...
            <a
              ...
              class="flex flex-col hover:opacity-80 transition group px-3 sm:px-4 lg:px-6"
            >
              <div class="text-xl sm:text-2xl font-normal text-[#D97706] tabular-nums">
                <span>{{ metrics()?.maintenance?.open_work_orders || 0 }}</span>
              </div>
              <span
                class="text-xs sm:text-sm font-normal text-[#64748B] group-hover:text-[#D97706] transition-colors mt-0.5"
                >Work Orders</span
              >
            </a>
            ...
            <a
              ...
              class="flex flex-col hover:opacity-80 transition group px-3 sm:px-4 lg:px-6 lg:last:pr-0"
            >
              <div class="text-xl sm:text-2xl font-normal text-[#0F172A] tabular-nums">
                <span>{{ metrics()?.total_tenants || 0 }}</span>
              </div>
              <span
                class="text-xs sm:text-sm font-normal text-[#64748B] group-hover:text-[#0F172A] transition-colors mt-0.5"
                >Total Tenants</span
              >
            </a>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-stretch">
            ...
            <div class="relative z-10">
              ...
              <div class="py-4 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4 border-t border-slate-100 pt-3">
                  <div>
                    <span class="text-[10px] text-[#047857] font-bold uppercase tracking-wider"
                      >Month Inward</span
                    >
                    <div
                  ...
                  <div>
                    <span class="text-[10px] text-[#DC2626] font-bold uppercase tracking-wider"
                      >Month Outward</span
                    >
                    <div
              ...
              <div class="py-4 space-y-4">
                ...
                <div class="flex items-center justify-between border-t border-slate-100 pt-3">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="text-xs font-semibold text-[#334155]"
                      >Expiring Soon (30 days)</span
                    >
                  </div>
              ...
              <div class="py-4 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4 border-t border-slate-100 pt-3">
                  <div>
                    ...
                    <div class="text-xl font-bold text-[#2563EB] tabular-nums mt-0.5">
                      {{ metrics()?.total_owners || 0 }}
                    </div>
                  </div>
                  <div>
                    <span class="text-[10px] text-[#64748B] font-semibold uppercase">Tenants</span>
                    <div class="text-xl font-bold text-[#047857] tabular-nums mt-0.5">
          ...
          <div
            class="md:col-span-4 h-full rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white via-rose-50/15 to-slate-50/80 border border-slate-200/80 p-5 sm:p-6 flex flex-col justify-between shadow-[0_10px_30px_rgba(15,23,42,0.06)] hover:shadow-[0_20px_40px_rgba(15,23,42,0.12)] hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group"
          >
            <!-- Background Opaque Watermark SVG Icon -->
            <div
              class="absolute -right-6 -bottom-6 text-[#DC2626] opacity-[0.035] pointer-events-none select-none transition-transform duration-500 group-hover:scale-110"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-44 h-44"
            ...
            <div class="relative z-10">
              <div class="flex items-center justify-between pb-3 border-b border-slate-200/80">
                <div class="flex items-center gap-2.5">
                  <div
                    class="w-7 h-7 rounded-xl bg-[#FEF2F2] border border-[#FECACA]/60 text-[#DC2626] flex items-center justify-center shrink-0 shadow-2xs"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-4 w-4"
              ...
              <div class="py-4 space-y-4">
                <div class="flex items-center justify-between">
                  ...
                  <span class="text-3xl font-bold text-[#DC2626] tabular-nums"> 4 </span>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 border-t border-slate-100 pt-3 text-xs">
                  ...
                  <a routerLink="/app/maintenance/inventory" class="hover:underline">
                    <span class="text-[10px] text-[#64748B] font-semibold uppercase"
                      >Inventory</span
                    >
            ...
            <a
              routerLink="/app/maintenance/work-orders"
              class="relative z-10 text-xs font-semibold text-[#DC2626] hover:underline inline-flex items-center gap-1 pt-1"
            >
          ...
          <div
            class="md:col-span-4 h-full rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white via-emerald-50/15 to-slate-50/80 border border-slate-200/80 p-5 sm:p-6 flex flex-col justify-between shadow-[0_10px_30px_rgba(15,23,42,0.06)] hover:shadow-[0_20px_40px_rgba(15,23,42,0.12)] hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group"
          >
            <!-- Background Opaque Watermark SVG Icon -->
            <div
              class="absolute -right-6 -bottom-6 text-[#047857] opacity-[0.035] pointer-events-none select-none transition-transform duration-500 group-hover:scale-110"
            ...
            <div class="relative z-10">
              ...
              <div class="py-4 space-y-3">
                ...
                <div class="w-full h-3 rounded-full bg-slate-200/80 overflow-hidden flex">
                  <div
                    class="h-full bg-[#047857] transition-all"
                    style="width: 65%"
                    title="Collected"
                  ></div>
                  <div
                    class="h-full bg-[#F59E0B] transition-all"
                    style="width: 13%"
                    title="Pending Cheques"
                  ></div>
                  <div
                    class="h-full bg-[#DC2626]/40 transition-all"
                    style="width: 22%"
                    title="Outstanding"
                  ></div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-2 text-center pt-2 border-t border-slate-100">
                  <div>
                    ...
                    <div class="text-[10px] text-[#047857]/80 font-semibold uppercase">
                      Collected
                    </div>
                  </div>
                  <div>
          ...
          <div
            class="md:col-span-4 h-full rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white via-slate-50/90 to-slate-100/60 border border-slate-200/80 p-5 sm:p-6 flex flex-col justify-between shadow-[0_10px_30px_rgba(15,23,42,0.06)] hover:shadow-[0_20px_40px_rgba(15,23,42,0.12)] hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group"
          >
            <!-- Background Opaque Watermark SVG Icon -->
            <div
              class="absolute -right-6 -bottom-6 text-slate-800 opacity-[0.035] pointer-events-none select-none transition-transform duration-500 group-hover:scale-110"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-44 h-44"
            ...
            <div class="relative z-10">
              <div class="flex items-center justify-between pb-3 border-b border-slate-200/80">
                <div class="flex items-center gap-2.5">
                  <div
                    class="w-7 h-7 rounded-xl bg-[#0F172A] text-white flex items-center justify-center shrink-0 shadow-2xs"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-4 w-4"
                ...
                <span class="text-[10px] font-semibold text-[#64748B] uppercase tracking-wider"
                  >ERP Workflows</span
                >
              </div>
              ...
              <div class="py-3 grid grid-cols-2 gap-2.5">
                ...
                >
                  <span>+ Owner</span>
                  <span class="text-[#64748B] group-hover/btn:translate-x-1 transition-transform"
                    >→</span
                  >
                </a>
                ...
                >
                  <span>+ Inward</span>
                  <span class="text-[#047857] group-hover/btn:translate-x-1 transition-transform"
                    >→</span
                  >
                </a>
                ...
                >
                  <span>+ Voucher</span>
                  <span class="text-[#DC2626] group-hover/btn:translate-x-1 transition-transform"
                    >→</span
                  >
                </a>
              </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-stretch pt-1">
          ...
          <div
            class="lg:col-span-8 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white via-slate-50/70 to-slate-100/40 border border-slate-200/80 p-5 sm:p-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)] hover:shadow-[0_18px_36px_rgba(15,23,42,0.10)] transition-all duration-300 space-y-4"
          >
            <div class="flex items-center justify-between pb-3 border-b border-slate-200/80">
              <div>
              ...
              <a
                routerLink="/app/accounts/dashboard"
                class="text-xs font-semibold text-[#047857] hover:underline flex items-center gap-1"
              >
            ...
            @if (accountsSnapshot()?.recent_transactions?.length) {
                  ...
                  <tbody class="divide-y divide-slate-200/80">
                    @for (tx of accountsSnapshot()!.recent_transactions.slice(0, 5); track tx.id) {
                      <tr class="hover:bg-slate-100/60 transition">
                        ...
                        <td class="py-3 font-medium text-[#0F172A] max-w-[150px] truncate">
                          {{ tx.party || tx.particulars || '—' }}
                        </td>
                        <td class="py-3 capitalize text-[#64748B]">
                          {{ tx.payment_mode.replace('_', ' ') }}
                        </td>
                        <td class="py-3">
                        ...
                        <td
                          ...
                          [class.text-[#047857]]="tx.direction === 'inward'"
                          [class.text-[#DC2626]]="tx.direction === 'outward'"
                        >
              ...
              <div class="py-8 text-center text-xs text-[#64748B]">
                No recent transactions logged for this branch.
              </div>
            }
          </div>
          ...
          <div
            class="lg:col-span-4 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white via-slate-50/70 to-slate-100/40 border border-slate-200/80 p-5 sm:p-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)] hover:shadow-[0_18px_36px_rgba(15,23,42,0.10)] transition-all duration-300 space-y-4"
          >
            <div class="flex items-center justify-between pb-3 border-b border-slate-200/80">
              <div>
            ...
            <div class="space-y-3">
              ...
              @if (
                metrics()?.expiring_soon_agreements && metrics()!.expiring_soon_agreements! > 0
              ) {
                <div
                  class="p-3 rounded-xl bg-[#FFFBEB] border border-[#FDE68A] flex items-start gap-3 text-xs shadow-2xs"
                >
                  <div
                    class="w-6 h-6 rounded-lg bg-[#D97706] text-white flex items-center justify-center shrink-0 mt-0.5 font-bold text-xs"
                  >
                    !
                  </div>
                  <div>
                    ...
                    <div class="text-[11px] text-[#334155] mt-0.5">
                      {{ metrics()?.expiring_soon_agreements }} tenant agreement(s) are approaching
              ...
              <div
                class="p-3 rounded-xl bg-white/90 border border-slate-200/80 flex items-start gap-3 text-xs shadow-2xs"
              >
                <div
                  class="w-6 h-6 rounded-lg bg-[#EFF6FF] text-[#2563EB] flex items-center justify-center shrink-0 mt-0.5"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-3.5 w-3.5"
                ...
                <div>
                  ...
                  <div class="text-[11px] text-[#64748B] mt-0.5">
                    ...
                    ></dirham-symbol
                    >{{ formatMoney(accountsSnapshot()?.pending_cheque_inward) }} awaiting bank
              ...
              >
                <div
                  class="w-6 h-6 rounded-lg bg-[#ECFDF5] text-[#047857] flex items-center justify-center shrink-0 mt-0.5"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-3.5 w-3.5"
              ...
              <div
                class="p-3 rounded-xl bg-[#ECFDF5]/90 border border-[#A7F3D0]/80 flex items-start gap-3 text-xs shadow-2xs"
              >
                <div
                  class="w-6 h-6 rounded-lg bg-[#047857] text-white flex items-center justify-center shrink-0 mt-0.5"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-3.5 w-3.5"
                ...
                <div>
                  ...
                  <div class="text-[11px] text-[#047857]/80 mt-0.5">
                    Collection efficiency is up 8.2% compared to last month across
...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  operationalCards(): Array<{ label: string; value: number; link: string }> {
    const summary = this.metrics()?.summary;
    return [
      {
        label: 'Owners',
        value: summary?.owners ?? this.metrics()?.total_owners ?? 0,
        link: '/app/customers/owners',
      },
      {
        label: 'Tenants',
        value: summary?.tenants ?? this.metrics()?.total_tenants ?? 0,
        link: '/app/customers/tenants',
      },
      {
        label: 'Properties',
        value: summary?.properties ?? this.metrics()?.total_properties ?? 0,
        link: '/app/properties',
      },
      {
        label: 'Owner Agreements',
        value: summary?.owner_agreements_active ?? this.metrics()?.total_owner_agreements ?? 0,
        link: '/app/owner-agreements',
      },
      {
        label: 'Tenant Agreements',
        value: summary?.tenant_agreements_active ?? this.metrics()?.total_tenant_agreements ?? 0,
        link: '/app/tenant-agreements',
      },
    ];
  }
