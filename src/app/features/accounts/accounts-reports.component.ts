...
@Component({ selector: 'bm-accounts-reports', standalone: true, imports: [CommonModule, RouterLink, BmPageHeaderComponent, BmLoadingStateComponent, BmErrorStateComponent, BmStatusBadgeComponent], template: `
