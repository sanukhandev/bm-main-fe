...
export class TenantAgreementDetailComponent implements OnInit {
  ...
  paymentLine = { direction: 'inward' as 'inward' | 'outward', category: '', particulars: '', amount: 0, due_date: new Date().toLocaleDateString('en-CA'), payment_mode: 'cash' as 'cash' | 'cheque' | 'bank_transfer', terms: '' };
